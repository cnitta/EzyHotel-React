...
import { ExecutiveSuiteCrudTable, ExecutiveSuiteNotification } from "dan-components";
...
class CrudTableDemo extends Component {
  ...
  componentDidMount() {
    fetch(SERVER_PREFIX + "/pricerates/roomtype/Executive Suite")
  ...
  render() {
    ...
    return (
      <div>
        <ExecutiveSuiteNotification close={() => closeNotif(branch)} message={messageNotif} />
        <div className={classes.rootTable}>
          {this.state.dataValue != '' &&
            <ExecutiveSuiteCrudTable
              dataInit={this.state.dataValue}
              anchor={anchorTable}
              title="Executive Suite Room Rates"
              dataTable={dataTable}
              fetchData={fetchData}
