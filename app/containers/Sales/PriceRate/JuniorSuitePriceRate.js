...
import { JuniorSuiteEditableCellDemo } from "./";
...
class Pricing extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      onClickButton: "",
      priceRateId: "",
      dynamicGroupPrice: "374.40",
      dynamicStandardPrice: "403.20",
      dynamicLeisurePrice: "432.00",
      dynamicCorporatePrice: "460.80"
    };
  }
  ...
  async componentDidMount(){
    try {
      setInterval(async () => {
        const dynamicPriceApi = await fetch(SERVER_PREFIX + "/pricerates/dynamicroomrate/Junior Suite");
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <div>
            <JuniorSuiteEditableCellDemo handleClickOpenSlide={this.handleClickOpenSlide} onClickButton={this.state.onClickButton} priceRateId={this.state.priceRateId} />
          </div>
        </PapperBlock>
        <Dialog
          open={openSlide}
