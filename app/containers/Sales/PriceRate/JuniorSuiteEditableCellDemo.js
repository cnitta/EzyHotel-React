...
import { JuniorSuiteCrudTable, JuniorSuiteNotification } from "dan-components";
...
class CrudTableDemo extends Component {
  ...
  componentDidMount() {
    fetch(SERVER_PREFIX + "/pricerates/roomtype/Junior Suite")
  ...
  render() {
    ...
    return (
      <div>
        <JuniorSuiteNotification close={() => closeNotif(branch)} message={messageNotif} />
        <div className={classes.rootTable}>
          {this.state.dataValue != '' &&
            <JuniorSuiteCrudTable
              dataInit={this.state.dataValue}
              anchor={anchorTable}
              title="Junior Suite Room Rates"
              dataTable={dataTable}
              fetchData={fetchData}
