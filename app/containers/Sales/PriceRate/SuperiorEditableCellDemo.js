...
import { SuperiorRoomCrudTable, SuperiorRoomNotification } from "dan-components";
...
class CrudTableDemo extends Component {
  ...
  componentDidMount() {
    fetch(SERVER_PREFIX + "/pricerates/roomtype/Superior")
  ...
  render() {
    ...
    return (
      <div>
        <SuperiorRoomNotification close={() => closeNotif(branch)} message={messageNotif} />
        <div className={classes.rootTable}>
          {this.state.dataValue != '' &&
          <SuperiorRoomCrudTable
            dataInit={this.state.dataValue}
            anchor={anchorTable}
            title="Superior Room Rates"
            dataTable={dataTable}
            fetchData={fetchData}
