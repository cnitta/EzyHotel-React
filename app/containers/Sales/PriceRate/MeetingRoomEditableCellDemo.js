...
import { MeetingRoomCrudTable, MeetingRoomNotification } from "dan-components";
...
class CrudTableDemo extends Component {
  ...
  componentDidMount() {
    fetch(SERVER_PREFIX + "/pricerates/facilityrate/Meeting Room")
  ...
  render() {
    ...
    return (
      <div>
        <MeetingRoomNotification close={() => closeNotif(branch)} message={messageNotif} />
        <div className={classes.rootTable}>
          {this.state.dataValue != '' &&
          <MeetingRoomCrudTable
            dataInit={this.state.dataValue}
            anchor={anchorTable}
            title="Meeting Room Rates"
            dataTable={dataTable}
            fetchData={fetchData}
