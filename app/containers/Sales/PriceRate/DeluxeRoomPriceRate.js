...
import { DeluxeEditableCellDemo } from "./";
...
class Pricing extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      onClickButton: "",
      priceRateId: "",
      dynamicGroupPrice: "244.40",
      dynamicStandardPrice: "263.20",
      dynamicLeisurePrice: "282.00",
      dynamicCorporatePrice: "300.80"
    };
  }
  ...
  async componentDidMount(){
    try {
      setInterval(async () => {
        const dynamicPriceApi = await fetch(SERVER_PREFIX + "/pricerates/dynamicroomrate/Deluxe");
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <div>
            <DeluxeEditableCellDemo handleClickOpenSlide={this.handleClickOpenSlide} onClickButton={this.state.onClickButton} priceRateId={this.state.priceRateId} />
          </div>
        </PapperBlock>
        <Dialog
          open={openSlide}
