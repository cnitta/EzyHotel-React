...
import { PresidentSuiteCrudTable, PresidentSuiteNotification } from "dan-components";
...
class CrudTableDemo extends Component {
  ...
  componentDidMount() {
    fetch(SERVER_PREFIX + "/pricerates/roomtype/President Suite")
  ...
  render() {
    ...
    return (
      <div>
        <PresidentSuiteNotification close={() => closeNotif(branch)} message={messageNotif} />
        <div className={classes.rootTable}>
          {this.state.dataValue != '' &&
            <PresidentSuiteCrudTable
              dataInit={this.state.dataValue}
              anchor={anchorTable}
              title="President Suite Room Rates"
              dataTable={dataTable}
              fetchData={fetchData}
