...
import { DeluxeRoomCrudTable, DeluxeRoomNotification } from "dan-components";
...
class CrudTableDemo extends Component {
  ...
  componentDidMount() {
    fetch(SERVER_PREFIX + "/pricerates/roomtype/Deluxe")
  ...
  render() {
    ...
    return (
      <div>
        <DeluxeRoomNotification close={() => closeNotif(branch)} message={messageNotif} />
        <div className={classes.rootTable}>
          {this.state.dataValue != '' &&
            <DeluxeRoomCrudTable
              dataInit={this.state.dataValue}
              anchor={anchorTable}
              title="Deluxe Room Rates"
              dataTable={dataTable}
              fetchData={fetchData}
