...
import {
  MeetingRoomAvailabilityEventCalendar,
  MeetingRoomAvailabilityDetailEvent,
  MeetingRoomAvailabilityAddEvent,
  MeetingRoomAvailabilityNotification
} from "dan-components";
import {
  fetchAction,
  addAction,
...
class Calendar extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(SERVER_PREFIX + "/programentries/calendar/meetingroom")
  	...
  	return (
  		<div>
  			<Helmet>
		 		...
		 		>
  			<MeetingRoomAvailabilityNotification close={() => closeNotif()} message={messageNotif} />
  			<div className={classes.root}>
  				<MeetingRoomAvailabilityEventCalendar events={eventData.toJS()} handleEventClick={this.handleClick} />
  				<MeetingRoomAvailabilityDetailEvent
  					event={event}
  					anchorEl={anchorEl}
  					anchorPos={anchorPos}
