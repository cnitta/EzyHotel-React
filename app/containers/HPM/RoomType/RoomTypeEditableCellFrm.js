...
import { RoomTypeCrudTableForm, RoomTypeNotification } from "dan-components";
import { anchorTable, dataApi } from "./RoomTypeData";
...
class CrudTbFormDemo extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <RoomTypeNotification
          close={() => closeNotif(branch)}
          message={messageNotif}
        />
        <div className={classes.rootTable}>
          <RoomTypeCrudTableForm
            dataTable={dataTable}
            openForm={openForm}
            dataInit={dataApi}
            anchor={anchorTable}
