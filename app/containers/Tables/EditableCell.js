    ...
    return (
      <div>
        ...
        <PapperBlock
          ...
          title="In-Row Editable Cell"
          desc="The Editable Table Cell supports editing features including creating, updating and deleting rows. The editing state contains information about rows currently being edited, changes applied to a particular row, and rows that have been deleted and created."
        >
        ...
        <PapperBlock
          ...
          title="Redux Form Editable Cell"
