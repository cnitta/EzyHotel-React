...
*/
class ProcessCheckOutFilter extends React.Component {
  constructor(props) {
    super(props);
  ...
  reloadData() {
    console.log(
      "Retrieve BookingId at Process CheckOutFilter: " + this.props.bookingId
    );
    Api.getSpecificRoomBooking(this.props.bookingId)
      .done(result => {
        console.log("Before Finalise Checkout data");
        console.log(this.state.finalBooking);
        this.setState({
          finalBooking: result
        });
        console.log("After Finalise Checkout data");
        console.log(this.state.finalBooking);
      })
      .fail(() => {
...
ProcessCheckOutFilter.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(ProcessCheckOutFilter);
