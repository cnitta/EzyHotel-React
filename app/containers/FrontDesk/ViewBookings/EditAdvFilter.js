...
import { EditRoomAllocation } from "dan-components";
...
*/
class EditAdvFilter extends React.Component {
  constructor(props) {
    super(props);
...

        {
          ...
          options: {
            ...
            customBodyRender: (value, tableMeta, updateValue) => {
              return (
                <div>
                  <EditRoomAllocation roomBookingId={value} />
                </div>
              );
            }
          }
  ...
  reloadData() {
    Api.viewBookingForEdit()
      .done(result => {
        console.log("Before EditFilter data");
        console.log(this.state.bookings);

        this.setState({
          bookings: result
        });
        console.log("After EditFilter data");
        console.log(this.state.bookings);
      })
      .fail(() => {
...
EditAdvFilter.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(EditAdvFilter);
