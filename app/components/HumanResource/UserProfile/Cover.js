...
class Cover extends React.Component {
  constructor(props) {
    ...
    console.log("id at cover " + this.state.id);
  }
  onClick = () => {
    this.props.history.push({
      pathname: "/app/editIndividual",
      state: { staffId: this.state.id }
    });
  };
  ...
  render() {
    const { classes, avatar, name, desc, coverImg } = this.props;
