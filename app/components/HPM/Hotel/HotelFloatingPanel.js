...
class HotelFloatingPanel extends React.Component {
  state = {
    expanded: false
  };
...
HotelFloatingPanel.defaultProps = {
  title: 'Add New Hotel',
  extraSize: false
};

const FloatingPanelResponsive = withWidth()(HotelFloatingPanel);
