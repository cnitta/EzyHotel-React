      ...
      <div>
        <Toolbar className={classes.toolbar}>
          ...
          <div className={classes.actions}>
            <Tooltip title="Add Sales Package">
              <Button variant="contained" onClick={() => this.props.handleAddNewClick()} color="secondary" className={classes.button}>
