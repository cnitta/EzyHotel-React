...
import ConferenceRoomAvailabilityAddEventForm from "./ConferenceRoomAvailabilityAddEventForm";
    ...
    return (
      <div>
        ...
        <FloatingPanel title="Add New Event" openForm={openForm} branch={branch} closeForm={() => closeForm()}>
          <ConventionAvailabilityAddEventForm onSubmit={(values) => this.showResult(values)} />
        </FloatingPanel>
      </div>
    );
  }
