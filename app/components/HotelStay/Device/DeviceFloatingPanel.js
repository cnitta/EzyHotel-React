...
class DeviceFloatingPanel extends React.Component {
  state = {
  	expanded: false
  }
...
DeviceFloatingPanel.defaultProps = {
  title: "Add New Item",
  extraSize: false,
};

const FloatingPanelResponsive = withWidth()(DeviceFloatingPanel);
