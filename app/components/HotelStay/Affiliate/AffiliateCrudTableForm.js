...
import AffiliateFloatingPanel from "./AffiliateFloatingPanel";
...
class CrudTableForm extends React.Component {
  ...
  sendValues = values => {
    ...
    if (values.get("affiliateId")) {
      setTimeout(() => {
        const putRequest = new Request(
          SERVER_PREFIX + "/affiliates/" + values.get("affiliateId"),
          {
            method: "PUT",
