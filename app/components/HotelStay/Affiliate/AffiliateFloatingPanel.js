...
class AffiliateFloatingPanel extends React.Component {
  state = {
  	expanded: false
  }
...
AffiliateFloatingPanel.propTypes = {
...
AffiliateFloatingPanel.defaultProps = {
  title: "Add New Item",
  extraSize: false,
};

const FloatingPanelResponsive = withWidth()(AffiliateFloatingPanel);
