...
class MerchandiseFloatingPanel extends React.Component {
  state = {
  	expanded: false
  }
...
MerchandiseFloatingPanel.propTypes = {
...
MerchandiseFloatingPanel.defaultProps = {
  title: "Add New Item",
  extraSize: false,
};

const FloatingPanelResponsive = withWidth()(MerchandiseFloatingPanel);
