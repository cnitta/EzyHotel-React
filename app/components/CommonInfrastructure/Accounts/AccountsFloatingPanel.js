...
class AccountsFloatingPanel extends React.Component {
  state = {
  	expanded: false
  }
...
AccountsFloatingPanel.propTypes = {
...
AccountsFloatingPanel.defaultProps = {
  title: "Add New Item",
  extraSize: false,
};

const FloatingPanelResponsive = withWidth()(AccountsFloatingPanel);
