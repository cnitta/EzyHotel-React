...
class AddEventForm extends React.Component {
  ...
  render() {
    const { classes, reset, pristine, submitting, handleSubmit } = this.props;
            ...
            <div className={classes.fieldBasic}>
              ...
              >
                ...
                <FormControlLabel
                  ...
                  control={
                    <Radio
                      className={classes.blueRadio}
                      classes={{
                        root: classes.blueRadio,
                        checked: classes.checked
                      }}
                    />
                  }
                ...
                <FormControlLabel
                  ...
                  control={
                    <Radio
                      className={classes.violetRadio}
                      classes={{
                        root: classes.violetRadio,
                        checked: classes.checked
                      }}
                    />
                  }
...
const AddEventInit = connect(state => ({
  force: state,
