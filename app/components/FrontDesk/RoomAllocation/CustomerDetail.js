...
const optionsOpt = ["Block Details", "Delete Details"];
        ...
        <section className={classes.cover}>
          <div className={classes.opt}>
            <IconButton
              ...
              aria-label="Favorite"
              onClick={() => favorite(dataContact.get(itemSelected))}
            >
            ...
            {/*<IconButton
              aria-label="Edit"
              onClick={() => edit(dataContact.get(itemSelected))}
            >
              <Edit />
            </IconButton>
                ...
                if (option === "Delete Contact") {
                  return (
                    <MenuItem
                      ...
                      onClick={() =>
                        this.deleteContact(dataContact.get(itemSelected))
                      }
                    >
                      {option}
                    </MenuItem>
          ...
          */}
          ...
          <Hidden xsDown>
            <Avatar
              alt={dataContact.getIn([itemSelected, "name"])}
              src={dataContact.getIn([itemSelected, "avatar"])}
        ...
        <div>
          ...
          <List>
            <ListItem>
              ...
              <ListItemText
                primary={dataContact.getIn([itemSelected, "phone"])}
                secondary="Phone"
              />
            </ListItem>
            ...
            <ListItem>
              ...
              <ListItemText
                primary={dataContact.getIn([itemSelected, "secondaryPhone"])}
            ...
            <ListItem>
              ...
              <ListItemText
                primary={dataContact.getIn([itemSelected, "personalEmail"])}
            ...
            <ListItem>
              ...
              <ListItemText
                primary={dataContact.getIn([itemSelected, "companyEmail"])}
            ...
            <ListItem>
              ...
              <ListItemText
                primary={dataContact.getIn([itemSelected, "address"])}
                secondary="Address"
              />
            </ListItem>
            <Divider variant="inset" />
            <ListItem>
              ...
              <ListItemText
                primary={dataContact.getIn([itemSelected, "website"])}
                secondary="Website"
              />
            </ListItem>
            ...
            <ListItem>
              ...
              <ListItemText
                primary={dataContact.getIn([itemSelected, "RoomNumber"])}
                secondary="Room Number"
              />
              {/* { RoomNumber: this.props.match.parms.id }*/}
            </ListItem>
